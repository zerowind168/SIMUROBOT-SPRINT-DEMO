...
enum {  simx_cmdnull_start              =0,
        ...
        simx_opmode_streaming           =0x020000,      /* sends command as one chunk. Command will be stored on the server and always executed (every x ms (as far as possible), where x can be 0-65535. just add x to simx_opmode_streaming). A reply will be sent fixedly, each time as one chunk. Doesn't wait for the reply. */
        simx_opmode_fixed          =0x020000,      /* same as simx_opmode_streaming */
